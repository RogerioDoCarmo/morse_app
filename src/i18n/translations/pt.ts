...
export const ptBR: TranslationMap = {
  ...
  'learn.gapMarksMeans': 'A mesma letra continua',
  'learn.gapLetters': 'Entre letras',
  'learn.gapLettersMeans': 'Aquela letra terminou',
  'learn.gapWords': 'Entre palavras',
  'learn.gapWordsMeans': 'Começa uma palavra nova',
  'learn.unit': 'unidade',
