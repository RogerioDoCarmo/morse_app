...
export const ptBR: TranslationMap = {
  ...
  'speech.micOff': 'O microfone está desligado',
  'speech.denied': 'Falar precisa dele. Digitar e tocar continuam funcionando.',
  'speech.openSettings': 'Abrir Ajustes',
  'channels.lightDenied': 'A Luz precisa da câmera',
  ...
  'settings.tapSection': 'ENTRADA POR TOQUE',
  'settings.languageSection': 'IDIOMA',
  'settings.outputSection': 'SAÍDA',
  'settings.wpm': '{{wpm}} PPM',
  'settings.readAloudHint': 'Usa a voz do idioma do app',
  'settings.privacySection': 'PRIVACIDADE',
  'settings.crashReports': 'Enviar relatórios de falha',
  ...
  'language.matchInterfaceHint': 'Reconhecer fala em {{language}}',
  'language.recogniseIn': 'Reconhecer fala em',
  'language.nameEn': 'Inglês',
  'language.namePt': 'Português do Brasil',
  'language.nameEs': 'Espanhol',
