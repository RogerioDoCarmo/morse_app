...
export const en: TranslationMap = {
  ...
  'firstRun.threeBody':
    'Try it here: tap one of those letters and you hear just that one. It is the quickest way to learn the rhythm — and the Learn tab has the whole alphabet whenever you want it.',
  ...
  'speech.micOff': 'Microphone is off',
  'speech.denied': 'Speaking needs it. Typing and tapping still work.',
  'speech.openSettings': 'Open Settings',
  'channels.lightDenied': 'Light needs the camera',
  'channels.openSettings': 'Settings',
