...
export const es: TranslationMap = {
  ...
  'translator.volumeLow': 'Sube el volumen',
  ...
  'speech.micOff': 'El micrófono está apagado',
  'speech.denied': 'Hablar lo necesita. Escribir y tocar siguen funcionando.',
  'speech.openSettings': 'Abrir Ajustes',
  'channels.lightDenied': 'La Luz necesita la cámara',
  'channels.openSettings': 'Ajustes',
